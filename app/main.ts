...
import {ROUTER_PROVIDERS, RouteConfig, RouterOutlet,RouterLink,ROUTER_DIRECTIVES} from 'angular2/router';

import { ListComponent } from 'app/list.component';
import { ListService } from 'app/list.service';
import { View1Component } from 'app/view1.component';
import { View2Component } from 'app/view2.component';
import { View3Component } from 'app/view3.component';
import { RegisterFormComponent } from 'app/register.component';
@Component({
  selector: 'my-app',
  directives: [ListComponent,ROUTER_DIRECTIVES,RouterOutlet,RouterLink],
  styles: [`
  h1 {
    color:#545454;
    background:#02A8F4;
  ...
  `],
  template: `
  <nav style="width: 100%;padding-botton:30px;">
